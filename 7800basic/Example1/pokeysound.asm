...
; v1.00 (19 Jan 2021)
;
; The 7800 pokey engine for music and sound effects playback on the Atari 7800 
; Console. This engine was initially developed (based on the disassembly and 
...
; for the Pac-man collection.
; 
; The 7800 pokey engine has now been kindly open-sourced by the contributors and 
; is freely available to the AtariAge community for use within any project.
; 
; The source is currently maintained by Matthew Smith (mksmith).
;-------------------------------------------------------------------------------
; CONTRIBUTORS:
; - Bob DeCrescenzo (pacmanplus), Perry Thuente (tep392), Bobby Clark (sythnpopalooza)
;   Mike Saarna (msaarna), Matthew Smith (mksmith), Paul Lay (playsoft)
; ADDITIONAL CODING:
; - 7800basic POKEY base pokeysound.asm code (msaarna)
...
;   replace the base pokeysound.asm in 7800basic with this file during
;   compilation
; - inline pokeyconfig.asm into your game source (generally within a 
;   shared bank so it can be accessed at all times)
; - inline your music.asm file(s) into your game source. These can be
;   within a shared back or within a bank that will be active during playback.
